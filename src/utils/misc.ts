...
export const docsPathMap: Record<string, string | undefined> = {
  ...
  [ModelNameEnum.JewelryInvoice]: 'books/sales-invoices',
  [ModelNameEnum.JewelryItem]: 'books/items',
  [ModelNameEnum.JewelryStockLedger]: 'books/stock-ledger',
  [ModelNameEnum.GoldRate]: 'books/taxes',
  [ModelNameEnum.DiamondRate]: 'books/taxes',
